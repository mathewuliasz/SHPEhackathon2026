      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {specialties.map((s) => (
          <button
            key={s.id}
            onClick={() => onSelect(s)}
            className="flex flex-col items-center justify-center gap-2 p-5 rounded-xl border border-gray-200 bg-white hover:shadow-lg hover:border-blue-500 transition-all cursor-pointer"
          >
