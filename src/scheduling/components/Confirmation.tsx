...
export function Confirmation({
  ...
  return (
    <div className="w-full max-w-6xl rounded-[30px] border border-[#e2eaf5] bg-white px-8 py-16 text-center shadow-[0_24px_50px_rgba(80,103,144,0.08)] sm:px-12 sm:py-20 lg:translate-x-[60px]">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center lg:translate-x-[32px]">
        ...
        <div className="mx-auto mb-8 grid w-full max-w-5xl gap-5 text-left md:grid-cols-2">
        ...
        <div className="mx-auto flex w-full max-w-4xl flex-wrap items-center justify-center gap-3">
          <Link
            ...
            className="inline-flex min-w-[220px] items-center justify-center rounded-[20px] border border-[#d9e3f2] bg-white px-6 py-3 font-semibold text-[#23324b] transition-colors hover:bg-[#f7faff]"
          >
            {t("confirm_goToChat")}
          </Link>
          <Link
