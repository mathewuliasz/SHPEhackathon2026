...
const translations = {
  en: {
    ...
    admin_tabVolunteers: "Volunteers",
    admin_tabAppointments: "Appointments",
    admin_tabPatients: "Patients",
    admin_patientName: "Name",
    admin_patientEmail: "Email",
    admin_patientJoined: "Joined",
    admin_appointmentDate: "Date",
    admin_appointmentTime: "Time",
    admin_appointmentDoctor: "Doctor",
    admin_appointmentSpecialty: "Specialty",
    admin_noAppointments: "No appointments scheduled yet.",
    admin_noPatients: "No patients registered yet.",
  },
  ...
  es: {
    ...
    admin_tabVolunteers: "Voluntarios",
    admin_tabAppointments: "Citas",
    admin_tabPatients: "Pacientes",
    admin_patientName: "Nombre",
    admin_patientEmail: "Correo",
    admin_patientJoined: "Unido",
    admin_appointmentDate: "Fecha",
    admin_appointmentTime: "Hora",
    admin_appointmentDoctor: "Doctor",
    admin_appointmentSpecialty: "Especialidad",
    admin_noAppointments: "Aún no hay citas programadas.",
    admin_noPatients: "Aún no hay pacientes registrados.",
  },
} as const;
